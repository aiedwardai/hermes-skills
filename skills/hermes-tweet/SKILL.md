...
This skill complements the existing `fenghuang-fm` news workflow with social
source discovery for X/Twitter. Use Hermes Tweet for tweet search, reply reading,
profile lookup, monitoring, and follower export. Keep posting, replies, DMs, and
account state changes behind explicit user approval.
